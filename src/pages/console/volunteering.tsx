...
import { Items, Button, Contain, Switch, SwitchBtn, Title } from '../../styles/style'

import EventCard from '../../components/cards/EventCard'

const Volunteering = (props): JSX.Element => {
  const { activeSection, eventVolunteered, data, isUser } = props
