...
const ScheduleOnboard = (props): JSX.Element => {
  const {} = props
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <List>
            <Title center> Event Schedules </Title>
            <hr />
            <Text center>
              Oasis Schedule for your event is a great way to create and organize whats been done
              during your event .
              <br />
              <br />
      ...
      >
        <img
          ...
          src={require('../../../assets/ssvg/schedule.svg')}
        />
      </Body>
    </div>
  )
...
export default ScheduleOnboard
