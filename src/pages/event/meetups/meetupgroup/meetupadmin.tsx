...
import { FiEdit, FiShoppingCart, FiArrowLeft } from 'react-icons/fi'
import { IoIosBug, IoMdMail, IoIosHome, IoMdConstruct } from 'react-icons/io'
...
const Admin = props => {
  ...
  return (
    <Window>
      <div>
        <Head header style={{ padding: '0rem 0.5rem' }}>
          <div
            style={{
              display: 'flex',
          ...
          >
            <Link style={{ textDecoration: 'none' }} to={`oasis/${eventType}/${id}`}>
              <Tab style={{ borderLeft: '0px' }}>
        ...
        <List>
          ...
          <Tab onClick={() => openAccessModal()} active={state.activeTab === 'access'}>
            <T style={{ padding: '0rem 1rem' }}>
