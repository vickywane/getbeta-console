...
import { InvitationOnboard } from '../user-onboard/'
        ...
        <div>
          <Head header>
            ...
            <Tab>
              ...
              <TabColumn onClick={() => setActiveColumn('draft')} active={ActiveColumn === 'draft'}>
                Draft
              </TabColumn>
            </Tab>
          </Head>
          ...
          <Body>
            <CSSTransition in={ActiveColumn === 'draft'} unmountOnExit timeout={300}>
              <EmptyData
            ...
            <CSSTransition in={ActiveColumn === 'overview'} unmountOnExit timeout={300}>
              <div>
            ...
            <CSSTransition in={ActiveColumn === 'compose'} unmountOnExit timeout={300}>
              <div>
                <div style={{ textAlign: 'right' }}>
                  <Hover
                    onClick={() => setActiveColumn('overview')}
